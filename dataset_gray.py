...
def prepare_data(data_path='data', train_filename='train_gray_data.h5'):
    # train
    ...
    files.sort()
    h5f = h5py.File('val_gray_data.h5', 'w')
    val_num = 0
    for i in range(len(files)):
...
class Dataset(udata.Dataset):
    def __init__(self, train=True, data_root='train_gray_data.h5'):
        ...
        if self.train:
            ...
            h5f = h5py.File('val_gray_data.h5', 'r')
...
if __name__ == '__main__':
    ...
    prepare_data(data_path='data', train_filename='train_gray_data.h5')

    # import visdom
    #
    # viz = visdom.Visdom()
    # dataset = Dataset(train=True, data_root="train_gray_data.h5")
